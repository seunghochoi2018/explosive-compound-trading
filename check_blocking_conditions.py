...
print("  ⚠️ min_confidence=40% 유지 (너무 낮추면 노이즈)")
print("  ✅ 신뢰도 65% → 즉시 전환 (빠른 반응)")
print()

print("[ETH 트레이더]")
print("  ⚠️⚠️ 문제: MIN_REVERSAL_DIFF=30, CONFIDENCE=85 너무 높음!")
